...
//       Manage organizers and administrators
//     </p>
//   </div> */}
//           <div>
...
//         {/* <div className="bg-white/80 backdrop-blur-md border border-white rounded-2xl shadow-xl p-6 mb-8 flex flex-wrap gap-6 items-end"> */}
...
//               // className="border border-slate-300 px-4 py-3 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:outline-none"
//               // className="w-56 rounded-2xl bg-slate-900/70 text-white border border-indigo-400/30 px-5 py-3 shadow-lg focus:border-cyan-400 focus:ring-4 focus:ring-cyan-400/20 outline-none"
// //               className="
// // w-56
// // rounded-2xl
// // bg-gradient-to-r
...
//               // className="border border-slate-300 px-4 py-3 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:outline-none"
//               // className="w-56 rounded-2xl bg-slate-900/70 text-white border border-indigo-400/30 px-5 py-3 shadow-lg focus:border-cyan-400 focus:ring-4 focus:ring-cyan-400/20 outline-none"
//               // className="w-56 rounded-2xl bg-gradient-to-r from-slate-800 to-slate-900 text-white border border-cyan-400/40 px-5 py-3 font-semibold shadow-[0_10px_30px_rgba(0,0,0,.35)] focus:outline-none focus:ring-4 focus:ring-cyan-400/30 focus:border-cyan-300 hover:border-cyan-300 transition-all duration-300 cursor-pointer appearance-none"
//               className="
// w-56
// rounded-2xl
// bg-slate-900/80
...
//               <option value="unapproved" className="bg-slate-900 text-white">
//                 Unapproved
//               </option> */}
//               <option
//   value="approved"
...
//             // className="bg-emerald-600 hover:bg-emerald-700 transition text-white px-5 py-3 rounded-xl shadow"
//             className="px-6 py-3 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold shadow-xl hover:scale-105 transition-all duration-300"
//           >
//             Events
//           </Link>
...
//             // className="bg-red-600 hover:bg-red-700 transition text-white px-5 py-3 rounded-xl shadow"
//             className="px-6 py-3 rounded-2xl bg-gradient-to-r from-rose-500 to-red-700 text-white font-bold shadow-xl hover:scale-105 transition-all duration-300"
//           >
//             Logout
//           </button>
//         </div>
...
//                         // className="mt-5 w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 transition text-white py-3 rounded-xl font-semibold shadow-lg"
